...
public struct AttachmentAudioState: Equatable {
    ...
    public var removeFullScreenAlert: AlertState<AttachmentAudioAction>?
    public var removeAlert: AlertState<AttachmentAudioAction>?
...
public struct AttachmentAudioEnvironment {
...
public let attachmentAudioReducer = Reducer<AttachmentAudioState, AttachmentAudioAction, AttachmentAudioEnvironment> { state, action, environment in
    ...
    case .onAppear:
        return environment.avAudioPlayerClient.create(id: PlayerManagerId(), url: state.entryAudio.url)
            .map(AttachmentAudioAction.audioPlayer)
    ...
    case .playButtonTapped:
        return environment.avAudioPlayerClient.isPlaying(id: PlayerManagerId())
            .map(AttachmentAudioAction.isPlayingResponse)
    ...
    case .playerProgressAddTimer:
        ...
        return environment.avAudioPlayerClient.currentTime(id: PlayerManagerId())
            .map(AttachmentAudioAction.playerProgressResponse)
        ...
        WithViewStore(store) { viewStore in
            Rectangle()
                ...
                .fullScreenCover(isPresented: viewStore.binding(
                    ...
                    send: AttachmentAudioAction.presentAudioFullScreen)
                ) {
                    VStack {
                        HStack(spacing: 8) {
                            Spacer()
