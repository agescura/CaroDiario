...
extension PDFKitClient {
  public static var live: PDFKitClient {
    PDFKitClient(
...
let pageRect: CGRect = CGRect(x: 0, y: 0, width: 8.5 * 72.0, height: 11 * 72.0)
let marginPoint: CGPoint = CGPoint(x: 10, y: 10)
let marginSize: CGSize = CGSize(width: 10 * 2 , height: 10 * 2)
